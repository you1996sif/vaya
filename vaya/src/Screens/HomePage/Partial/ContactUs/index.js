            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div className={classes.contact}>
                        ...
                        <div><h1>هل لديك أي اقتراح ؟
                            <br />...او تريد ان تقول مرحبا
                            </h1></div>
                        <div><a style={{ textDecoration: ' none', color:'#707070',fontFamily: 'Poppins, sans-serif', fontWeight:'bold',fontSize:'20px' }} href={'https://instagram.com/vaya.n.p?utm_medium=copy_link'} target="_blank" > VAYA-Instgram Page</a></div>
                    </div>
                </div>
            </div>
        </Grid>
